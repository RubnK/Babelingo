...
export default function Languages() {
  ...
  useEffect(() => {
    const fetchLanguages = async () => {
      try {
        const res = await axios.get(`${import.meta.env.VITE_API_GAMEPLAY}/languages`);
  ...
  if (loading) {
    return <div className="min-h-screen flex items-center justify-center">Chargement des langues...</div>;
  }
  return (
